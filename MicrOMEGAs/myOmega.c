...
{    
  ...
  printf("\n=== MASSES OF EXTRA GAUGE BOSONS: ===\n");
   ...
   char*  pname = pdg2name(31);   /* MZp Mass */
   double mass;
   ...
   if(pname)
   {
    mass=pMass(pname);
    printf("\n%s : %E \n",pname,mass);
    fprintf(omega,"   400   %2.6E   #MZp\n",mass);
   }
 
    pname = pdg2name(25);    /* MH1 Mass */
  if(pname)
  {
    mass=pMass(pname);
    printf("\n%s : %E \n",pname,mass);
    fprintf(omega,"   401   %2.6E   #mh1\n",mass);
  }

    pname = pdg2name(35);    /* MH2 Mass */
  if(pname)
  {
    mass=pMass(pname);
    printf("\n%s : %E \n",pname,mass);
    fprintf(omega,"   402   %2.6E   #mh2\n",mass);
  }


    pname = pdg2name(45);    /* MH3 Mass */
  if(pname)
  {
    mass=pMass(pname);
    printf("\n%s : %E \n",pname,mass);
    fprintf(omega,"   403   %2.6E   #mh3\n",mass);
  }

    pname = pdg2name(55);    /* MH4 Mass */
  if(pname)
  {
    mass=pMass(pname);
    printf("\n%s : %E \n",pname,mass);
    fprintf(omega,"   404   %2.6E   #mh4\n",mass);
  }

    pname = pdg2name(65);    /* MH5 Mass */
  if(pname)
  {
    mass=pMass(pname);
    printf("\n%s : %E \n",pname,mass);
    fprintf(omega,"   405   %2.6E   #mh5\n",mass);
  }

    pname = pdg2name(75);    /* MH6 Mass */
  if(pname)
  {
    mass=pMass(pname);
    printf("\n%s : %E \n",pname,mass);
    fprintf(omega,"   406   %2.6E   #mh6\n",mass);
  }

    pname = pdg2name(56);    /* MA1 Mass */
  if(pname)
  {
    mass=pMass(pname);
    printf("\n%s : %E \n",pname,mass);
    fprintf(omega,"   407   %2.6E   #a1\n",mass);
  }

    pname = pdg2name(66);    /* MA2 Mass */
  if(pname)
  {
    mass=pMass(pname);
    printf("\n%s : %E \n",pname,mass);
    fprintf(omega,"   408   %2.6E   #a2\n",mass);
  }
...
/*
  ...
  /* Cross section of Zp */
  char*  outgoing11 = pdg2name(31); /* Zp boson */  
  if(outgoing11)
  {
     double cs_tot, cs1, cs2, cs3, cs4, cs5, cs6, Pcm=6500, Qren, Qfact, pTmin=0;
     int nf=3;
  ...
  /* Cross section of Cha1 AntiCha1 */
  char*  outgoing12 = pdg2name(1000024); /* Cha1 boson */
  if(outgoing12)
  {
     double cs1, Pcm=6500, Qren, Qfact, pTmin=0;
     int nf=3;
     Qren=Qfact=nextM;
     ...
     cs1=hCollider(Pcm,1,nf,Qren, Qfact, outgoing12, antiParticle(outgoing12), pTmin, 1);
     printf("cs(pp-> %s %s)=%.2E[pb]\n",outgoing12, antiParticle(outgoing12), cs1);
     fprintf(omega, "   904   %E   #cs(pp-> %s %s)\n", cs1, outgoing12, antiParticle(outgoing12));
  }  


  /* Cross section of Cha1 AntiChi2 */
  char*  outgoing13 = pdg2name(1000022); /* Chi1 boson */
  char*  outgoing14 = pdg2name(1000023); /* Chi2 boson */
  if(outgoing12)
  {
     double cs1, Pcm=6500, Qren, Qfact, pTmin=0;
     int nf=3;
     ...
     cs1=hCollider(Pcm,1,nf,Qren, Qfact, outgoing12, antiParticle(outgoing14), pTmin, 1);
     printf("cs(pp-> %s %s)=%.2E[pb]\n",outgoing12, antiParticle(outgoing14), cs1);
     fprintf(omega, "   905   %E   #cs(pp-> %s %s)\n", cs1, outgoing12, antiParticle(outgoing14));
  }


  /* Cross section of Chi2 AntiCha1 */
  if(outgoing12)
  {
     double cs1, Pcm=6500, Qren, Qfact, pTmin=0;
     int nf=3;
     ...
     cs1=hCollider(Pcm,1,nf,Qren, Qfact, outgoing14, antiParticle(outgoing12), pTmin, 1);
     printf("cs(pp-> %s %s)=%.2E[pb]\n",outgoing14, antiParticle(outgoing12), cs1);
     fprintf(omega, "   906   %E   #cs(pp-> %s %s)\n", cs1, outgoing14, antiParticle(outgoing12));
  }  
