...
! ------------------------------------------------------------------------------  
! File created at 1:03 on 7.11.2019   
! ----------------------------------------------------------------------  
 
 
Module OneLoopDecay_Su_sec_UMSSM
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_sec_UMSSM_SuToSuAh(cplAhSucSu,MAh,MSu,MAh2,MSu2,Amp)

Implicit None

Real(dp), Intent(in) :: MAh(6),MSu(6),MAh2(6),MSu2(6)

Complex(dp), Intent(in) :: cplAhSucSu(6,6,6)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SuToSuAh


Subroutine Gamma_Real_sec_UMSSM_SuToSuAh(MLambda,em,gs,cplAhSucSu,MAh,MSu,            & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SuToSuAh


Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuAh(cplAhSucSu,ctcplAhSucSu,MAh,             & 
& MAh2,MSu,MSu2,ZfAh,ZfSu,Amp)

Implicit None

Real(dp), Intent(in) :: MAh(6),MAh2(6),MSu(6),MSu2(6)

Complex(dp), Intent(in) :: cplAhSucSu(6,6,6)

Complex(dp), Intent(in) :: ctcplAhSucSu(6,6,6)

Complex(dp), Intent(in) :: ZfAh(6,6),ZfSu(6,6)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuAh


Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuAh(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
...
& cplSuSucSucSuabba,cplSuSucSucSuabab,cplSuSvcSucSvaa,Amp)
...
& cplAhSucSu(6,6,6),cplAhSvcSv(6,6,6),cplAhcHpmVWm(6,2),cplcFdChaSuL(3,2,6),             & 
& cplcFdChaSuR(3,2,6),cplChiFucSuL(9,3,6),cplChiFucSuR(9,3,6),cplcFuChiSuL(3,9,6),       & 
& cplcFuChiSuR(3,9,6),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplGluFucSuL(3,6),       & 
& cplGluFucSuR(3,6),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhSucSu(6,6,6),               & 
& cplHpmSucSd(2,6,6),cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),cplSucSuVG(6,6),              & 
& cplSucSuVP(6,6),cplSucSdVWm(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplAhAhSucSuaa(6,6,6,6),& 
& cplAhhhSucSuaa(6,6,6,6),cplAhHpmSucSdaa(6,2,6,6),cplAhSdcHpmcSuaa(6,6,2,6),            & 
& cplhhhhSucSuaa(6,6,6,6),cplHpmSucHpmcSuaa(2,6,2,6),cplSdSucSdcSuabba(6,6,6,6),         & 
& cplSdSucSdcSuabab(6,6,6,6),cplSeSucSecSuaa(6,6,6,6),cplSuSucSucSuabba(6,6,6,6),        & 
& cplSuSucSucSuabab(6,6,6,6),cplSuSvcSucSvaa(6,6,6,6)
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuAh


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuAh(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,             & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhAh,        & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,       & 
& cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhSvcSv,cplAhcHpmVWm,cplcFdChaSuL,    & 
& cplcFdChaSuR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcChaFdcSuL,        & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuAh


Subroutine Amplitude_Tree_sec_UMSSM_SuToFuChi(cplChiFucSuL,cplChiFucSuR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SuToFuChi


Subroutine Gamma_Real_sec_UMSSM_SuToFuChi(MLambda,em,gs,cplChiFucSuL,cplChiFucSuR,    & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SuToFuChi


Subroutine Amplitude_WAVE_sec_UMSSM_SuToFuChi(cplChiFucSuL,cplChiFucSuR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SuToFuChi


Subroutine Amplitude_VERTEX_sec_UMSSM_SuToFuChi(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SuToFuChi


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToFuChi(MAh,MCha,MChi,MFd,MFu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToFuChi


Subroutine Amplitude_Tree_sec_UMSSM_SuTocChaFd(cplcChaFdcSuL,cplcChaFdcSuR,           & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SuTocChaFd


Subroutine Gamma_Real_sec_UMSSM_SuTocChaFd(MLambda,em,gs,cplcChaFdcSuL,               & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SuTocChaFd


Subroutine Amplitude_WAVE_sec_UMSSM_SuTocChaFd(cplcChaFdcSuL,cplcChaFdcSuR,           & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SuTocChaFd


Subroutine Amplitude_VERTEX_sec_UMSSM_SuTocChaFd(MAh,MCha,MChi,MFd,MFu,               & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SuTocChaFd


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuTocChaFd(MAh,MCha,MChi,MFd,MFu,            & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,cplcChaChaAhR,           & 
& cplcFdFdAhL,cplcFdFdAhR,cplAhSucSu,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,          & 
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuTocChaFd


Subroutine Amplitude_Tree_sec_UMSSM_SuToGluFu(cplGluFucSuL,cplGluFucSuR,              & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SuToGluFu


Subroutine Gamma_Real_sec_UMSSM_SuToGluFu(MLambda,em,gs,cplGluFucSuL,cplGluFucSuR,    & 
...
End if 
    End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SuToGluFu


Subroutine Amplitude_WAVE_sec_UMSSM_SuToGluFu(cplGluFucSuL,cplGluFucSuR,              & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SuToGluFu


Subroutine Amplitude_VERTEX_sec_UMSSM_SuToGluFu(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3,6),cplcFuFuAhR(3,3,6),cplAhSucSu(6,6,6),cplChaFucSdL(2,3,6),          & 
& cplChaFucSdR(2,3,6),cplChiFucSuL(9,3,6),cplChiFucSuR(9,3,6),cplGluFdcSdL(3,6),         & 
& cplGluFdcSdR(3,6),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplGluFucSuL(3,6),         & 
& cplGluFucSuR(3,6),cplcFuFuhhL(3,3,6),cplcFuFuhhR(3,3,6),cplcFdFuHpmL(3,3,2),           & 
& cplcFdFuHpmR(3,3,2),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),& 
& cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFuFuVZpL(3,3),& 
& cplcFuFuVZpR(3,3),cplGluGluVGL,cplGluGluVGR,cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),       & 
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhSucSu(6,6,6),cplSdcHpmcSu(6,2,6),             & 
& cplSdcSucVWm(6,6),cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6)
...
Amp(:,gt1, gt3) = Amp(:,gt1, gt3) + oo16pi2*(-3._dp/2._dp*(0.,1._dp))*AmpC 
  End Do
    End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SuToGluFu


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToGluFu(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcFuFuAhL,cplcFuFuAhR,               & 
& cplAhSucSu,cplChaFucSdL,cplChaFucSdR,cplChiFucSuL,cplChiFucSuR,cplGluFdcSdL,           & 
& cplGluFdcSdR,cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,cplGluFucSuR,cplcFuFuhhL,        & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToGluFu


Subroutine Amplitude_Tree_sec_UMSSM_SuToSuhh(cplhhSucSu,Mhh,MSu,Mhh2,MSu2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SuToSuhh


Subroutine Gamma_Real_sec_UMSSM_SuToSuhh(MLambda,em,gs,cplhhSucSu,Mhh,MSu,            & 
& GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SuToSuhh


Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuhh(cplhhSucSu,ctcplhhSucSu,Mhh,             & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuhh


Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuhh(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,             & 
...
ML1 = MVZp 
ML2 = MVZp 
coup1 = cplSucSuVZpVZpaa(gt2,gt1)
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuhh


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuhh(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuhh


Subroutine Amplitude_Tree_sec_UMSSM_SuTocHpmSd(cplSdcHpmcSu,MHpm,MSd,MSu,             & 
& MHpm2,MSd2,MSu2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SuTocHpmSd


Subroutine Gamma_Real_sec_UMSSM_SuTocHpmSd(MLambda,em,gs,cplSdcHpmcSu,MHpm,           & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SuTocHpmSd


Subroutine Amplitude_WAVE_sec_UMSSM_SuTocHpmSd(cplSdcHpmcSu,ctcplSdcHpmcSu,           & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SuTocHpmSd


Subroutine Amplitude_VERTEX_sec_UMSSM_SuTocHpmSd(MAh,MCha,MChi,MFd,MFu,               & 
& MGlu,Mhh,MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,             & 
...
ML1 = MVZp 
ML2 = MVWm 
coup1 = cplSdcSucVWmVZpaa(gt3,gt1)
coup2 = cplcHpmVWmVZp(gt2)
If (Abs(coup1)*Abs(coup2).gt.epsCoup) Then 
Call Amp_VERTEX_StoSS_Topology3_VV(Mex1,Mex2,Mex3,ML1,ML2,coup1,coup2,AmpC) 
Else
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SuTocHpmSd


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuTocHpmSd(MAh,MCha,MChi,MFd,MFu,            & 
& MGlu,Mhh,MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,             & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhHpmcHpm,     & 
& cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplChiFucSuL,         & 
& cplChiFucSuR,cplcFdChiSdL,cplcFdChiSdR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFuFdcHpmL,      & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuTocHpmSd


Subroutine Amplitude_Tree_sec_UMSSM_SuToSdcVWm(cplSdcSucVWm,MSd,MSu,MVWm,             & 
& MSd2,MSu2,MVWm2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SuToSdcVWm


Subroutine Gamma_Real_sec_UMSSM_SuToSdcVWm(MLambda,em,gs,cplSdcSucVWm,MSd,            & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SuToSdcVWm


Subroutine Amplitude_WAVE_sec_UMSSM_SuToSdcVWm(cplSdcSucVWm,ctcplSdcSucVWm,           & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SuToSdcVWm


Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSdcVWm(MAh,MCha,MChi,MFd,MFu,               & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
...
& cplSdcSucVWmVZpaa,cplSucSucVWmVWmaa,Amp)
...
Complex(dp), Intent(in) :: cplAhHpmcVWm(6,2),cplAhSdcSd(6,6,6),cplAhSucSu(6,6,6),cplChiChacVWmL(9,2),            & 
& cplChiChacVWmR(9,2),cplChiFucSuL(9,3,6),cplChiFucSuR(9,3,6),cplcFdChiSdL(3,9,6),       & 
& cplcFdChiSdR(3,9,6),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplcFuFdcVWmL(3,3),      & 
& cplcFuFdcVWmR(3,3),cplGluFucSuL(3,6),cplGluFucSuR(3,6),cplcFdGluSdL(3,6),              & 
& cplcFdGluSdR(3,6),cplhhHpmcVWm(6,2),cplhhSdcSd(6,6,6),cplhhSucSu(6,6,6),               & 
& cplhhcVWmVWm(6),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),cplHpmcVWmVZp(2),cplSdcSdVG(6,6),      & 
...
& cplSucSuVZp(6,6),cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplSdcSucVWmVGLamct4ct2ct1(6,6),& 
& cplSdcSucVWmVPaa(6,6),cplSdcSdcVWmVWmaa(6,6),cplSdcSucVWmVZaa(6,6),cplSdcSucVWmVZpaa(6,6),& 
...
ML1 = MSd(i1) 
ML2 = MVZp 
coup1 = cplSdcSucVWmVZpaa(i1,gt1)
coup2 = cplSdcSdVZp(gt2,i1)
If (Abs(coup1)*Abs(coup2).gt.epsCoup) Then 
Call Amp_VERTEX_StoSV_Topology3_SV(Mex1,Mex2,Mex3,ML1,ML2,coup1,coup2,AmpC) 
Else
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSdcVWm


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSdcVWm(MAh,MCha,MChi,MFd,MFu,            & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhHpmcVWm,cplAhSdcSd,               & 
& cplAhSucSu,cplChiChacVWmL,cplChiChacVWmR,cplChiFucSuL,cplChiFucSuR,cplcFdChiSdL,       & 
& cplcFdChiSdR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplGluFucSuL,     & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSdcVWm


Subroutine Amplitude_Tree_sec_UMSSM_SuToSuVZ(cplSucSuVZ,MSu,MVZ,MSu2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SuToSuVZ


Subroutine Gamma_Real_sec_UMSSM_SuToSuVZ(MLambda,em,gs,cplSucSuVZ,MSu,MVZ,            & 
& GammarealPhoton,GammarealGluon)
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SuToSuVZ


Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuVZ(cplSucSuVP,cplSucSuVZ,cplSucSuVZp,       & 
...
Complex(dp), Intent(in) :: cplSucSuVP(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6)

Complex(dp), Intent(in) :: ctcplSucSuVP(6,6),ctcplSucSuVZ(6,6),ctcplSucSuVZp(6,6)

Complex(dp), Intent(in) :: ZfSu(6,6),ZfVPVZ,ZfVZ,ZfVZpVZ
...
ZcoupT1 = ZcoupT1 + 0.5_dp*ZfVZpVZ*cplSucSuVZp(gt2,gt1)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuVZ


Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& cplSucSuVPVZaa,cplSucSdVWmVZaa,cplSucSuVZVZaa,cplSucSuVZVZpaa,Amp)
...
Complex(dp), Intent(in) :: cplAhhhVZ(6,6),cplAhSucSu(6,6,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),             & 
...
& cplcFuGluSuR(3,6),cplhhSucSu(6,6,6),cplhhVZVZ(6),cplhhVZVZp(6),cplHpmSucSd(2,6,6),     & 
& cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplSdcSdVZ(6,6),cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),& 
& cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSdVWm(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),     & 
& cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplSdcSucVWmVZaa(6,6),cplSucSuVGVZLamct3ct2ct1(6,6),      & 
& cplSucSuVPVZaa(6,6),cplSucSdVWmVZaa(6,6),cplSucSuVZVZaa(6,6),cplSucSuVZVZpaa(6,6)
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuVZ


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuVZ(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZ,cplAhSucSu,cplcFdChaSuL,     & 
& cplcFdChaSuR,cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplChiFucSuL,       & 
& cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcFdFdVZL,cplcFdFdVZR,cplcChaFdcSuL,          & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuVZ


Subroutine Amplitude_Tree_sec_UMSSM_SuToSuVZp(cplSucSuVZp,MSu,MVZp,MSu2,              & 
& MVZp2,Amp)

Implicit None

Real(dp), Intent(in) :: MSu(6),MVZp,MSu2(6),MVZp2

Complex(dp), Intent(in) :: cplSucSuVZp(6,6)
...
Mex3 = MVZp 
! Tree-Level Vertex 
coupT1 = -cplSucSuVZp(gt2,gt1)
Call TreeAmp_StoSV(Mex1,Mex2,Mex3,coupT1,AmpC) 
! Colour and symmetry factor 
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SuToSuVZp


Subroutine Gamma_Real_sec_UMSSM_SuToSuVZp(MLambda,em,gs,cplSucSuVZp,MSu,              & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SuToSuVZp


Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuVZp(cplSucSuVP,cplSucSuVZ,cplSucSuVZp,      & 
& ctcplSucSuVP,ctcplSucSuVZ,ctcplSucSuVZp,MSu,MSu2,MVP,MVP2,MVZp,MVZp2,ZfSu,             & 
& ZfVPVZp,ZfVZp,ZfVZVZp,Amp)

Implicit None

Real(dp), Intent(in) :: MSu(6),MSu2(6),MVP,MVP2,MVZp,MVZp2

Complex(dp), Intent(in) :: cplSucSuVP(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6)

Complex(dp), Intent(in) :: ctcplSucSuVP(6,6),ctcplSucSuVZ(6,6),ctcplSucSuVZp(6,6)

Complex(dp), Intent(in) :: ZfSu(6,6),ZfVPVZp,ZfVZp,ZfVZVZp
...
! Coupling counter term 
!----------------------------- 
ZcoupT1 = ctcplSucSuVZp(gt2,gt1) 
!----------------------------- 
! Multiply Z-factors 
!----------------------------- 
! External Field 1 
Do i1=1,6
ZcoupT1 = ZcoupT1 + 0.5_dp*Conjg(ZfSu(i1,gt1))*cplSucSuVZp(gt2,i1)
End Do


! External Field 2 
Do i1=1,6
ZcoupT1 = ZcoupT1 + 0.5_dp*ZfSu(i1,gt2)*cplSucSuVZp(i1,gt1)
End Do


! External Field 3 
ZcoupT1 = ZcoupT1 + 0.5_dp*ZfVPVZp*cplSucSuVP(gt2,gt1)
ZcoupT1 = ZcoupT1 + 0.5_dp*ZfVZVZp*cplSucSuVZ(gt2,gt1)
ZcoupT1 = ZcoupT1 + 0.5_dp*ZfVZp*cplSucSuVZp(gt2,gt1)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuVZp


Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuVZp(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
Complex(dp), Intent(in) :: cplAhhhVZp(6,6),cplAhSucSu(6,6,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),            & 
...
& cplGluFucSuL(3,6),cplGluFucSuR(3,6),cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),               & 
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhSucSu(6,6,6),cplhhVZVZp(6),cplhhVZpVZp(6),    & 
& cplHpmSucSd(2,6,6),cplHpmcHpmVZp(2,2),cplHpmcVWmVZp(2),cplSdcSdVZp(6,6),               & 
& cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSdVWm(6,6),& 
& cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplcHpmVWmVZp(2),cplcVWmVWmVZp,cplSdcSucVWmVZpaa(6,6),& 
& cplSucSuVGVZpLamct3ct2ct1(6,6),cplSucSuVPVZpaa(6,6),cplSucSdVWmVZpaa(6,6),             & 
& cplSucSuVZVZpaa(6,6),cplSucSuVZpVZpaa(6,6)
...
ML2 = MVG 
coup1 = -cplSucSuVG(i1,gt1)
coup2 = cplSucSuVGVZpLamct3ct2ct1(gt2,i1)
Call Amp_VERTEX_StoSV_Topology2_SV(Mex1,Mex2,Mex3,ML1,ML2,coup1,coup2,AmpC) 
! Colour and symmetry Factor 
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(4._dp/3._dp)*AmpC 
End Do
...
ML1 = MSu(i1) 
ML2 = MVG 
coup1 = cplSucSuVGVZpLamct3ct2ct1(i1,gt1)
coup2 = cplSucSuVG(gt2,i1)
If (Abs(coup1)*Abs(coup2).gt.epsCoup) Then 
Call Amp_VERTEX_StoSV_Topology3_SV(Mex1,Mex2,Mex3,ML1,ML2,coup1,coup2,AmpC) 
Else
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuVZp


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuVZp(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZp,cplAhSucSu,cplcFdChaSuL,    & 
& cplcFdChaSuR,cplcChaChaVZpL,cplcChaChaVZpR,cplChiChiVZpL,cplChiChiVZpR,cplChiFucSuL,   & 
& cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcFdFdVZpL,cplcFdFdVZpR,cplcChaFdcSuL,        & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuVZp


Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuVG(cplSucSuVG,ctcplSucSuVG,MSu,             & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuVG


Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuVG(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhSucSu,cplcFdChaSuL,               & 
...
& cplHpmSucSd,cplSdcSdVG,cplSdcHpmcSu,cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSdVWm,    & 
& cplSucSuVZ,cplSucSuVZp,cplVGVGVG,cplSdcSucVWmVGLamct4ct2ct1,cplSucSuVGVGsumj113Lamct3ct2j1Lamct4j1ct1,& 
& cplSucSuVGVGsumj113Lamct3j1ct1Lamct4ct2j1,cplSucSuVGVPLamct3ct2ct1,cplSucSdVGVWmLamct3ct2ct1,& 
& cplSucSuVGVZLamct3ct2ct1,cplSucSuVGVZpLamct3ct2ct1,Amp)
...
Complex(dp), Intent(in) :: cplAhSucSu(6,6,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplChiFucSuL(9,3,6),        & 
& cplChiFucSuR(9,3,6),cplcFuChiSuL(3,9,6),cplcFuChiSuR(3,9,6),cplcFdFdVGL(3,3),          & 
...
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhSucSu(6,6,6),cplHpmSucSd(2,6,6),              & 
& cplSdcSdVG(6,6),cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),cplSucSuVG(6,6),cplSucSuVP(6,6), & 
& cplSucSdVWm(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplVGVGVG,cplSdcSucVWmVGLamct4ct2ct1(6,6),& 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuVG


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuVG(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhSucSu,cplcFdChaSuL,               & 
& cplcFdChaSuR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcFdFdVGL,          & 
& cplcFdFdVGR,cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,cplGluFucSuR,cplcFuFuVGL,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuVG


Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuVP(cplSucSuVP,cplSucSuVZ,cplSucSuVZp,       & 
...
Complex(dp), Intent(in) :: ZfSu(6,6),ZfVP,ZfVZpVP,ZfVZVP
...
ZcoupT1 = ZcoupT1 + 0.5_dp*ZfVZpVP*cplSucSuVZp(gt2,gt1)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SuToSuVP


Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuVP(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhSucSu,cplcFdChaSuL,               & 
& cplcFdChaSuR,cplcChaChaVPL,cplcChaChaVPR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,       & 
& cplcFuChiSuR,cplcFdFdVPL,cplcFdFdVPR,cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,         & 
& cplGluFucSuR,cplcFuFuVPL,cplcFuFuVPR,cplcFuGluSuL,cplcFuGluSuR,cplhhSucSu,             & 
& cplHpmSucSd,cplHpmcHpmVP,cplHpmcVWmVP,cplSdcSdVP,cplSdcHpmcSu,cplSdcSucVWm,            & 
...
& cplSucSuVPVZaa,cplSucSuVPVZpaa,Amp)
...
Complex(dp), Intent(in) :: cplAhSucSu(6,6,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplcChaChaVPL(2,2),         & 
& cplcChaChaVPR(2,2),cplChiFucSuL(9,3,6),cplChiFucSuR(9,3,6),cplcFuChiSuL(3,9,6),        & 
& cplcFuChiSuR(3,9,6),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcChaFdcSuL(2,3,6),            & 
& cplcChaFdcSuR(2,3,6),cplGluFucSuL(3,6),cplGluFucSuR(3,6),cplcFuFuVPL(3,3),             & 
& cplcFuFuVPR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhSucSu(6,6,6),cplHpmSucSd(2,6,6),& 
& cplHpmcHpmVP(2,2),cplHpmcVWmVP(2),cplSdcSdVP(6,6),cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),& 
& cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSdVWm(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),     & 
& cplcHpmVPVWm(2),cplcVWmVPVWm,cplSdcSucVWmVPaa(6,6),cplSucSuVGVPLamct3ct2ct1(6,6),      & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SuToSuVP


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuVP(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhSucSu,cplcFdChaSuL,               & 
& cplcFdChaSuR,cplcChaChaVPL,cplcChaChaVPR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,       & 
& cplcFuChiSuR,cplcFdFdVPL,cplcFdFdVPR,cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SuToSuVP



End Module OneLoopDecay_Su_sec_UMSSM
