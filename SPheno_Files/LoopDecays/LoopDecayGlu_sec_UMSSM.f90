...
Module OneLoopDecay_Glu_sec_UMSSM
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_sec_UMSSM_GluToFdcSd(cplGluFdcSdL,cplGluFdcSdR,             & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_Tree_sec_UMSSM_GluToFdcSd


Subroutine Gamma_Real_sec_UMSSM_GluToFdcSd(MLambda,em,gs,cplGluFdcSdL,cplGluFdcSdR,   & 
...
End if 
    End Do
  End Do
End Subroutine Gamma_Real_sec_UMSSM_GluToFdcSd


Subroutine Amplitude_WAVE_sec_UMSSM_GluToFdcSd(cplGluFdcSdL,cplGluFdcSdR,             & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_GluToFdcSd


Subroutine Amplitude_VERTEX_sec_UMSSM_GluToFdcSd(MAh,MCha,MChi,MFd,MFu,               & 
...
Amp(:,gt2, gt3) = Amp(:,gt2, gt3) + oo16pi2*(-3._dp/2._dp*(0.,1._dp))*AmpC 
    ...
    End Do
  End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_GluToFdcSd


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToFdcSd(MAh,MCha,MChi,MFd,MFu,            & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcFdFdAhL,cplcFdFdAhR,               & 
& cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,cplChiFdcSdL,cplChiFdcSdR,cplGluFdcSdL,           & 
& cplGluFdcSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToFdcSd


Subroutine Amplitude_Tree_sec_UMSSM_GluToFucSu(cplGluFucSuL,cplGluFucSuR,             & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_Tree_sec_UMSSM_GluToFucSu


Subroutine Gamma_Real_sec_UMSSM_GluToFucSu(MLambda,em,gs,cplGluFucSuL,cplGluFucSuR,   & 
...
End if 
    End Do
  End Do
End Subroutine Gamma_Real_sec_UMSSM_GluToFucSu


Subroutine Amplitude_WAVE_sec_UMSSM_GluToFucSu(cplGluFucSuL,cplGluFucSuR,             & 
...
Amp(:,gt2, gt3) = AmpC 
    End Do
  End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_GluToFucSu


Subroutine Amplitude_VERTEX_sec_UMSSM_GluToFucSu(MAh,MCha,MChi,MFd,MFu,               & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
...
Amp(:,gt2, gt3) = Amp(:,gt2, gt3) + oo16pi2*(-3._dp/2._dp*(0.,1._dp))*AmpC 
    ...
    End Do
  End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_GluToFucSu


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToFucSu(MAh,MCha,MChi,MFd,MFu,            & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcFuFuAhL,cplcFuFuAhR,               & 
& cplAhSucSu,cplChaFucSdL,cplChaFucSdR,cplChiFucSuL,cplChiFucSuR,cplGluFdcSdL,           & 
& cplGluFdcSdR,cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,cplGluFucSuR,cplcFuFuhhL,        & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToFucSu


Subroutine Amplitude_WAVE_sec_UMSSM_GluToChiVG(MChi,MChi2,MGlu,MGlu2,MVG,             & 
...
Amp(:,gt2) = 0._dp
  End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_GluToChiVG


Subroutine Amplitude_VERTEX_sec_UMSSM_GluToChiVG(MChi,MFd,MFu,MGlu,MSd,               & 
...
End Do
  End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_GluToChiVG


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToChiVG(MChi,MFd,MFu,MGlu,MSd,            & 
& MSu,MVG,MChi2,MFd2,MFu2,MGlu2,MSd2,MSu2,MVG2,cplChiFdcSdL,cplChiFdcSdR,cplChiFucSuL,   & 
& cplChiFucSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFuChiSuL,cplcFuChiSuR,cplGluFdcSdL,         & 
& cplGluFdcSdR,cplcFdFdVGL,cplcFdFdVGR,cplGluFucSuL,cplGluFucSuR,cplcFuFuVGL,            & 
& cplcFuFuVGR,cplcFdGluSdL,cplcFdGluSdR,cplcFuGluSuL,cplcFuGluSuR,cplSdcSdVG,            & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToChiVG


Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluAh(MAh,MAh2,MGlu,MGlu2,ZfAh,ZffG,Amp)

Implicit None

Real(dp), Intent(in) :: MAh(6),MAh2(6),MGlu,MGlu2

Complex(dp), Intent(in) :: ZfAh(6,6),ZffG
...
Amp(:,gt3) = 0._dp
    End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluAh


Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluAh(MAh,MFd,MFu,MGlu,MSd,MSu,            & 
...
Real(dp), Intent(in) :: MAh(6),MFd(3),MFu(3),MGlu,MSd(6),MSu(6),MAh2(6),MFd2(3),MFu2(3),MGlu2,MSd2(6),MSu2(6)

Complex(dp), Intent(in) :: cplcFdFdAhL(3,3,6),cplcFdFdAhR(3,3,6),cplcFuFuAhL(3,3,6),cplcFuFuAhR(3,3,6),          & 
& cplAhSdcSd(6,6,6),cplAhSucSu(6,6,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),               & 
...
End Do
    End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluAh


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluAh(MAh,MFd,MFu,MGlu,MSd,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluAh


Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluhh(MGlu,MGlu2,Mhh,Mhh2,ZffG,Zfhh,Amp)
...
Amp(:,gt3) = 0._dp
    End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluhh


Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluhh(MFd,MFu,MGlu,Mhh,MSd,MSu,            & 
...
End Do
    End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluhh


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluhh(MFd,MFu,MGlu,Mhh,MSd,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluhh


Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluVG(cplGluGluVGL,cplGluGluVGR,             & 
...
Amp(:) = -AmpC 
End Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluVG


Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluVG(MFd,MFu,MGlu,MSd,MSu,MVG,            & 
...
Amp(:) = Amp(:) + oo16pi2*(1._dp/4._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluVG


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluVG(MFd,MFu,MGlu,MSd,MSu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluVG


Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluVP(MGlu,MGlu2,MVP,MVP2,ZffG,ZfVP,Amp)
...
! External Field 3 
Amp(:) = 0._dp
End Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluVP


Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluVP(MFd,MFu,MGlu,MSd,MSu,MVP,            & 
...
Amp(:) = Amp(:) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluVP


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluVP(MFd,MFu,MGlu,MSd,MSu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluVP


Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluVZ(MGlu,MGlu2,MVZ,MVZ2,ZffG,ZfVZ,Amp)
...
! External Field 3 
Amp(:) = 0._dp
End Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluVZ


Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluVZ(MFd,MFu,MGlu,MSd,MSu,MVZ,            & 
...
Amp(:) = Amp(:) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluVZ


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluVZ(MFd,MFu,MGlu,MSd,MSu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluVZ


Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluVZp(MGlu,MGlu2,MVZp,MVZp2,ZffG,           & 
& ZfVZp,Amp)

Implicit None

Real(dp), Intent(in) :: MGlu,MGlu2,MVZp,MVZp2

Complex(dp), Intent(in) :: ZffG,ZfVZp
...
! External Field 3 
Amp(:) = 0._dp
End Subroutine Amplitude_WAVE_sec_UMSSM_GluToGluVZp


Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluVZp(MFd,MFu,MGlu,MSd,MSu,               & 
& MVZp,MFd2,MFu2,MGlu2,MSd2,MSu2,MVZp2,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVZpL,           & 
& cplcFdFdVZpR,cplGluFucSuL,cplGluFucSuR,cplcFuFuVZpL,cplcFuFuVZpR,cplcFdGluSdL,         & 
& cplcFdGluSdR,cplcFuGluSuL,cplcFuGluSuR,cplSdcSdVZp,cplSucSuVZp,Amp)

Implicit None

Real(dp), Intent(in) :: MFd(3),MFu(3),MGlu,MSd(6),MSu(6),MVZp,MFd2(3),MFu2(3),MGlu2,MSd2(6),MSu2(6),MVZp2

Complex(dp), Intent(in) :: cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplcFdFdVZpL(3,3),cplcFdFdVZpR(3,3),              & 
& cplGluFucSuL(3,6),cplGluFucSuR(3,6),cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),               & 
& cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),               & 
& cplSdcSdVZp(6,6),cplSucSuVZp(6,6)
...
Amp(:) = Amp(:) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_GluToGluVZp


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluVZp(MFd,MFu,MGlu,MSd,MSu,            & 
& MVZp,MFd2,MFu2,MGlu2,MSd2,MSu2,MVZp2,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVZpL,           & 
& cplcFdFdVZpR,cplGluFucSuL,cplGluFucSuR,cplcFuFuVZpL,cplcFuFuVZpR,cplcFdGluSdL,         & 
& cplcFdGluSdR,cplcFuGluSuL,cplcFuGluSuR,cplSdcSdVZp,cplSucSuVZp,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_GluToGluVZp



End Module OneLoopDecay_Glu_sec_UMSSM
