...
Module OneLoopDecay_Sd_sec_UMSSM
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_sec_UMSSM_SdToSdAh(cplAhSdcSd,MAh,MSd,MAh2,MSd2,Amp)

Implicit None

Real(dp), Intent(in) :: MAh(6),MSd(6),MAh2(6),MSd2(6)

Complex(dp), Intent(in) :: cplAhSdcSd(6,6,6)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SdToSdAh


Subroutine Gamma_Real_sec_UMSSM_SdToSdAh(MLambda,em,gs,cplAhSdcSd,MAh,MSd,            & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SdToSdAh


Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdAh(cplAhSdcSd,ctcplAhSdcSd,MAh,             & 
& MAh2,MSd,MSd2,ZfAh,ZfSd,Amp)

Implicit None

Real(dp), Intent(in) :: MAh(6),MAh2(6),MSd(6),MSd2(6)

Complex(dp), Intent(in) :: cplAhSdcSd(6,6,6)

Complex(dp), Intent(in) :: ctcplAhSdcSd(6,6,6)

Complex(dp), Intent(in) :: ZfAh(6,6),ZfSd(6,6)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdAh


Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdAh(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
...
& cplSdSucSdcSuabba,cplSdSucSdcSuabab,cplSdSvcSdcSvaa,Amp)
...
& cplAhSucSu(6,6,6),cplAhSvcSv(6,6,6),cplAhcHpmVWm(6,2),cplChaFucSdL(2,3,6),             & 
& cplChaFucSdR(2,3,6),cplChiFdcSdL(9,3,6),cplChiFdcSdR(9,3,6),cplcFdChiSdL(3,9,6),       & 
& cplcFdChiSdR(3,9,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplcFdGluSdL(3,6),             & 
& cplcFdGluSdR(3,6),cplhhSdcSd(6,6,6),cplHpmSucSd(2,6,6),cplSdcSdVG(6,6),cplSdcSdVP(6,6),& 
& cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),            & 
& cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),cplSucSdVWm(6,6),cplAhAhSdcSdaa(6,6,6,6),        & 
& cplAhhhSdcSdaa(6,6,6,6),cplAhHpmSucSdaa(6,2,6,6),cplAhSdcHpmcSuaa(6,6,2,6),            & 
& cplhhhhSdcSdaa(6,6,6,6),cplHpmSdcHpmcSdaa(2,6,2,6),cplSdSdcSdcSdabba(6,6,6,6),         & 
& cplSdSdcSdcSdabab(6,6,6,6),cplSdSecSdcSeaa(6,6,6,6),cplSdSucSdcSuabba(6,6,6,6),        & 
& cplSdSucSdcSuabab(6,6,6,6),cplSdSvcSdcSvaa(6,6,6,6)
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdAh


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdAh(MAh,MCha,MChi,MFd,MFu,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdAh


Subroutine Amplitude_Tree_sec_UMSSM_SdToFuCha(cplChaFucSdL,cplChaFucSdR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SdToFuCha


Subroutine Gamma_Real_sec_UMSSM_SdToFuCha(MLambda,em,gs,cplChaFucSdL,cplChaFucSdR,    & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SdToFuCha


Subroutine Amplitude_WAVE_sec_UMSSM_SdToFuCha(cplChaFucSdL,cplChaFucSdR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SdToFuCha


Subroutine Amplitude_VERTEX_sec_UMSSM_SdToFuCha(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
...
& cplChiChacVWmR(9,2),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplcChaChahhL(2,2,6),      & 
& cplcChaChahhR(2,2,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplcChaChaVPL(2,2),       & 
...
& cplChiFucSuR(9,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplGluFucSuL(3,6),             & 
...
& cplcFuFuVZpR(3,3),cplhhSdcSd(6,6,6),cplHpmSucSd(2,6,6),cplSdcSdVG(6,6),cplSdcSdVP(6,6),& 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SdToFuCha


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToFuCha(MAh,MCha,MChi,MFd,MFu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToFuCha


Subroutine Amplitude_Tree_sec_UMSSM_SdToFdChi(cplChiFdcSdL,cplChiFdcSdR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SdToFdChi


Subroutine Gamma_Real_sec_UMSSM_SdToFdChi(MLambda,em,gs,cplChiFdcSdL,cplChiFdcSdR,    & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SdToFdChi


Subroutine Amplitude_WAVE_sec_UMSSM_SdToFdChi(cplChiFdcSdL,cplChiFdcSdR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SdToFdChi


Subroutine Amplitude_VERTEX_sec_UMSSM_SdToFdChi(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SdToFdChi


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToFdChi(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplChiChiAhL,cplChiChiAhR,             & 
& cplcFdFdAhL,cplcFdFdAhR,cplAhSdcSd,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,       & 
& cplChiChacVWmR,cplChaFucSdL,cplChaFucSdR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToFdChi


Subroutine Amplitude_Tree_sec_UMSSM_SdToGluFd(cplGluFdcSdL,cplGluFdcSdR,              & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SdToGluFd


Subroutine Gamma_Real_sec_UMSSM_SdToGluFd(MLambda,em,gs,cplGluFdcSdL,cplGluFdcSdR,    & 
...
End if 
    End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SdToGluFd


Subroutine Amplitude_WAVE_sec_UMSSM_SdToGluFd(cplGluFdcSdL,cplGluFdcSdR,              & 
...
Amp(:,gt1, gt3) = AmpC 
    End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SdToGluFd


Subroutine Amplitude_VERTEX_sec_UMSSM_SdToGluFd(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
Complex(dp), Intent(in) :: cplcFdFdAhL(3,3,6),cplcFdFdAhR(3,3,6),cplAhSdcSd(6,6,6),cplChaFucSdL(2,3,6),          & 
& cplChaFucSdR(2,3,6),cplChiFdcSdL(9,3,6),cplChiFdcSdR(9,3,6),cplGluFdcSdL(3,6),         & 
...
Amp(:,gt1, gt3) = Amp(:,gt1, gt3) + oo16pi2*(-3._dp/2._dp*(0.,1._dp))*AmpC 
  End Do
    End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SdToGluFd


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToGluFd(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcFdFdAhL,cplcFdFdAhR,               & 
& cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,cplChiFdcSdL,cplChiFdcSdR,cplGluFdcSdL,           & 
& cplGluFdcSdR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToGluFd


Subroutine Amplitude_Tree_sec_UMSSM_SdToSdhh(cplhhSdcSd,Mhh,MSd,Mhh2,MSd2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SdToSdhh


Subroutine Gamma_Real_sec_UMSSM_SdToSdhh(MLambda,em,gs,cplhhSdcSd,Mhh,MSd,            & 
& GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SdToSdhh


Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdhh(cplhhSdcSd,ctcplhhSdcSd,Mhh,             & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdhh


Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdhh(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,             & 
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdhh


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdhh(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdhh


Subroutine Amplitude_Tree_sec_UMSSM_SdToSuHpm(cplHpmSucSd,MHpm,MSd,MSu,               & 
& MHpm2,MSd2,MSu2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SdToSuHpm


Subroutine Gamma_Real_sec_UMSSM_SdToSuHpm(MLambda,em,gs,cplHpmSucSd,MHpm,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SdToSuHpm


Subroutine Amplitude_WAVE_sec_UMSSM_SdToSuHpm(cplHpmSucSd,ctcplHpmSucSd,              & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SdToSuHpm


Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSuHpm(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,             & 
...
Complex(dp), Intent(in) :: cplAhHpmcHpm(6,2,2),cplAhHpmcVWm(6,2),cplAhSdcSd(6,6,6),cplAhSucSu(6,6,6),            & 
& cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),       & 
& cplChiFdcSdL(9,3,6),cplChiFdcSdR(9,3,6),cplcChaChiHpmL(2,9,2),cplcChaChiHpmR(2,9,2),   & 
& cplcFuChiSuL(3,9,6),cplcFuChiSuR(3,9,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),           & 
& cplcFdFuHpmL(3,3,2),cplcFdFuHpmR(3,3,2),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),           & 
& cplhhHpmcHpm(6,2,2),cplhhHpmcVWm(6,2),cplhhSdcSd(6,6,6),cplhhSucSu(6,6,6),             & 
...
& cplSucSdVWm(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplAhHpmSucSdaa(6,2,6,6),            & 
& cplhhHpmSucSdaa(6,2,6,6),cplHpmSdcHpmcSdaa(2,6,2,6),cplHpmSucHpmcSuaa(2,6,2,6),        & 
& cplSdSucSdcSuabba(6,6,6,6),cplSdSucSdcSuabab(6,6,6,6),cplSeSucSdcSvaa(6,6,6,6),        & 
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSuHpm


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSuHpm(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSuHpm


Subroutine Amplitude_Tree_sec_UMSSM_SdToSdVZ(cplSdcSdVZ,MSd,MVZ,MSd2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SdToSdVZ


Subroutine Gamma_Real_sec_UMSSM_SdToSdVZ(MLambda,em,gs,cplSdcSdVZ,MSd,MVZ,            & 
& GammarealPhoton,GammarealGluon)
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SdToSdVZ


Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdVZ(cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,       & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdVZ


Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdVZ(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
Complex(dp), Intent(in) :: cplAhhhVZ(6,6),cplAhSdcSd(6,6,6),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),             & 
...
& cplcFuFuVZR(3,3),cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplhhSdcSd(6,6,6),cplhhVZVZ(6),   & 
& cplhhVZVZp(6),cplHpmSucSd(2,6,6),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplSdcSdVG(6,6),    & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdVZ


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdVZ(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZ,cplAhSdcSd,cplChaFucSdL,     & 
& cplChaFucSdR,cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplChiFdcSdL,       & 
& cplChiFdcSdR,cplcFdChiSdL,cplcFdChiSdR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVZL,          & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdVZ


Subroutine Amplitude_Tree_sec_UMSSM_SdToSdVZp(cplSdcSdVZp,MSd,MVZp,MSd2,              & 
& MVZp2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SdToSdVZp


Subroutine Gamma_Real_sec_UMSSM_SdToSdVZp(MLambda,em,gs,cplSdcSdVZp,MSd,              & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SdToSdVZp


Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdVZp(cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,      & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdVZp


Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdVZp(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
Complex(dp), Intent(in) :: cplAhhhVZp(6,6),cplAhSdcSd(6,6,6),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),            & 
...
& cplhhSdcSd(6,6,6),cplhhVZVZp(6),cplhhVZpVZp(6),cplHpmSucSd(2,6,6),cplHpmcHpmVZp(2,2),  & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdVZp


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdVZp(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZp,cplAhSdcSd,cplChaFucSdL,    & 
& cplChaFucSdR,cplcChaChaVZpL,cplcChaChaVZpR,cplChiChiVZpL,cplChiChiVZpR,cplChiFdcSdL,   & 
& cplChiFdcSdR,cplcFdChiSdL,cplcFdChiSdR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVZpL,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdVZp


Subroutine Amplitude_Tree_sec_UMSSM_SdToSuVWm(cplSucSdVWm,MSd,MSu,MVWm,               & 
& MSd2,MSu2,MVWm2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_sec_UMSSM_SdToSuVWm


Subroutine Gamma_Real_sec_UMSSM_SdToSuVWm(MLambda,em,gs,cplSucSdVWm,MSd,              & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_sec_UMSSM_SdToSuVWm


Subroutine Amplitude_WAVE_sec_UMSSM_SdToSuVWm(cplSucSdVWm,ctcplSucSdVWm,              & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SdToSuVWm


Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSuVWm(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
Complex(dp), Intent(in) :: cplAhSdcSd(6,6,6),cplAhSucSu(6,6,6),cplAhcHpmVWm(6,2),cplChaFucSdL(2,3,6),            & 
& cplChaFucSdR(2,3,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplChiFdcSdL(9,3,6),       & 
& cplChiFdcSdR(9,3,6),cplcFuChiSuL(3,9,6),cplcFuChiSuR(3,9,6),cplcChaChiVWmL(2,9),       & 
& cplcChaChiVWmR(2,9),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplcFdFuVWmL(3,3),             & 
& cplcFdFuVWmR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplhhSdcSd(6,6,6),               & 
& cplhhSucSu(6,6,6),cplhhcHpmVWm(6,2),cplhhcVWmVWm(6),cplHpmSucSd(2,6,6),cplSdcSdVG(6,6),& 
& cplSdcSdVP(6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplSucSuVG(6,6),cplSucSuVP(6,6),      & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSuVWm


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSuVWm(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,    & 
& cplChaFucSdL,cplChaFucSdR,cplcFdChaSuL,cplcFdChaSuR,cplChiFdcSdL,cplChiFdcSdR,         & 
& cplcFuChiSuL,cplcFuChiSuR,cplcChaChiVWmL,cplcChaChiVWmR,cplGluFdcSdL,cplGluFdcSdR,     & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSuVWm


Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdVG(cplSdcSdVG,ctcplSdcSdVG,MSd,             & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdVG


Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdVG(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
Complex(dp), Intent(in) :: cplAhSdcSd(6,6,6),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChiFdcSdL(9,3,6),        & 
& cplChiFdcSdR(9,3,6),cplcFdChiSdL(3,9,6),cplcFdChiSdR(3,9,6),cplGluFdcSdL(3,6),         & 
& cplGluFdcSdR(3,6),cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3), & 
& cplGluGluVGL,cplGluGluVGR,cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplhhSdcSd(6,6,6),       & 
& cplHpmSucSd(2,6,6),cplSdcSdVG(6,6),cplSdcSdVP(6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),   & 
& cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),       & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdVG


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdVG(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhSdcSd,cplChaFucSdL,               & 
& cplChaFucSdR,cplChiFdcSdL,cplChiFdcSdR,cplcFdChiSdL,cplcFdChiSdR,cplGluFdcSdL,         & 
& cplGluFdcSdR,cplcFdFdVGL,cplcFdFdVGR,cplcFuFuVGL,cplcFuFuVGR,cplGluGluVGL,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdVG


Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdVP(cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,       & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_sec_UMSSM_SdToSdVP


Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdVP(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhSdcSd,cplChaFucSdL,               & 
...
Complex(dp), Intent(in) :: cplAhSdcSd(6,6,6),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplcChaChaVPL(2,2),         & 
& cplcChaChaVPR(2,2),cplChiFdcSdL(9,3,6),cplChiFdcSdR(9,3,6),cplcFdChiSdL(3,9,6),        & 
& cplcFdChiSdR(3,9,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplcFdFdVPL(3,3),              & 
& cplcFdFdVPR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),& 
& cplhhSdcSd(6,6,6),cplHpmSucSd(2,6,6),cplHpmcHpmVP(2,2),cplHpmcVWmVP(2),cplSdcSdVG(6,6),& 
& cplSdcSdVP(6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),& 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_sec_UMSSM_SdToSdVP


Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdVP(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhSdcSd,cplChaFucSdL,               & 
& cplChaFucSdR,cplcChaChaVPL,cplcChaChaVPR,cplChiFdcSdL,cplChiFdcSdR,cplcFdChiSdL,       & 
& cplcFdChiSdR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVPL,cplcFdFdVPR,cplcFuFuVPL,            & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_sec_UMSSM_SdToSdVP



End Module OneLoopDecay_Sd_sec_UMSSM
