...
& ms12,ms22,ms32,mv2,M1,M2,M3,M4,vd,vu,vS,vS1,vS2,vS3,gTSd,gTSu,gGluFdcFdChi,            & 
...
Real(dp),Intent(inout) :: gGluFdcFdChi(1,3,3,9),gGluFdcFucCha(1,3,3,2),gGluFucFuChi(1,3,3,9)

Real(dp),Intent(in) :: gTSd(6),gTSu(6)

Real(dp) :: gGluFdcFdChii(3,3,9),gGluFdcFucChai(3,3,2),gGluFucFuChii(3,3,9)
...
& me2,ms2,ms12,ms22,ms32,mv2,M1,M2,M3,M4,vd,vu,vS,vS1,vS2,vS3,cplcChacFuSdL,             & 
...
Real(dp),Intent(in) :: MFd(3),MChi(9),MSd(6),MGlu
...
Real(dp),Intent(in) :: MFu(3),MChi(9),MSu(6),MGlu
...
End Module Glu3Decays_sec_UMSSM 
