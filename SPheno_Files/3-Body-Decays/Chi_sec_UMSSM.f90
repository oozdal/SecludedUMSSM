...
Real(dp),Intent(inout) :: gChiChicChaCha(9,9,2,2),gChiChiChiChi(9,9,9,9),gChiChicFdFd(9,9,3,3),gChiChicFeFe(9,9,3,3),& 
& gChiChicFuFu(9,9,3,3),gChiChicFvFv(9,9,3,3),gChiChacFdFu(9,2,3,3),gChiChacFeFv(9,2,3,3),& 
& gChiFdcFdGlu(9,3,3,1),gChiFucFuGlu(9,3,3,1)

Real(dp),Intent(in) :: gTAh(6),gThh(6),gTHpm(2),gTSd(6),gTSe(6),gTSu(6),gTSv(6),gTVWm,gTVZ,gTVZp

Real(dp) :: gChiChicChaChai(9,2,2),gChiChiChiChii(9,9,9),gChiChicFdFdi(9,3,3),gChiChicFeFei(9,3,3),& 
& gChiChicFuFui(9,3,3),gChiChicFvFvi(9,3,3),gChiChacFdFui(2,3,3),gChiChacFeFvi(2,3,3),   & 
...
& md2,mu2,me2,ms2,ms12,ms22,ms32,mv2,M1,M2,M3,M4,vd,vu,vS,vS1,vS2,vS3,cplcChaChaAhL,     & 
...
Real(dp),Intent(in) :: MChi(9),MCha(2),MVZ,MVZp,MVWm,MHpm(2),MAh(6),Mhh(6)
...
Real(dp),Intent(in) :: MChi(9),MVZ,MVZp,MAh(6),Mhh(6)

Complex(dp),Intent(in) :: cplChiChiAhL(9,9,6),cplChiChiAhR(9,9,6),cplChiChihhL(9,9,6),cplChiChihhR(9,9,6),      & 
& cplChiChiVZL(9,9),cplChiChiVZR(9,9),cplChiChiVZpL(9,9),cplChiChiVZpR(9,9)
...
Real(dp),Intent(in) :: MChi(9),MFd(3),MVZ,MVZp,MSd(6),MAh(6),Mhh(6)

Complex(dp),Intent(in) :: cplcFdChiSdL(3,9,6),cplcFdChiSdR(3,9,6),cplcFdFdAhL(3,3,6),cplcFdFdAhR(3,3,6),        & 
& cplcFdFdhhL(3,3,6),cplcFdFdhhR(3,3,6),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),               & 
& cplcFdFdVZpL(3,3),cplcFdFdVZpR(3,3),cplChiChiAhL(9,9,6),cplChiChiAhR(9,9,6),           & 
...
Real(dp),Intent(in) :: MChi(9),MFe(3),MVZ,MVZp,MSe(6),MAh(6),Mhh(6)

Complex(dp),Intent(in) :: cplcFeChiSeL(3,9,6),cplcFeChiSeR(3,9,6),cplcFeFeAhL(3,3,6),cplcFeFeAhR(3,3,6),        & 
& cplcFeFehhL(3,3,6),cplcFeFehhR(3,3,6),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),               & 
& cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),cplChiChiAhL(9,9,6),cplChiChiAhR(9,9,6),           & 
& cplChiChihhL(9,9,6),cplChiChihhR(9,9,6),cplChiChiVZL(9,9),cplChiChiVZR(9,9),           & 
& cplChiChiVZpL(9,9),cplChiChiVZpR(9,9),cplChiFecSeL(9,3,6),cplChiFecSeR(9,3,6)
...
Real(dp),Intent(in) :: MChi(9),MFu(3),MVZ,MVZp,MSu(6),MAh(6),Mhh(6)

Complex(dp),Intent(in) :: cplcFuChiSuL(3,9,6),cplcFuChiSuR(3,9,6),cplcFuFuAhL(3,3,6),cplcFuFuAhR(3,3,6),        & 
& cplcFuFuhhL(3,3,6),cplcFuFuhhR(3,3,6),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),               & 
& cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),cplChiChiAhL(9,9,6),cplChiChiAhR(9,9,6),           & 
& cplChiChihhL(9,9,6),cplChiChihhR(9,9,6),cplChiChiVZL(9,9),cplChiChiVZR(9,9),           & 
& cplChiChiVZpL(9,9),cplChiChiVZpR(9,9),cplChiFucSuL(9,3,6),cplChiFucSuR(9,3,6)
...
Real(dp),Intent(in) :: MChi(9),MFv(3),MVZ,MVZp,MSv(6),MAh(6),Mhh(6)

Complex(dp),Intent(in) :: cplcFvChiSvL(3,9,6),cplcFvChiSvR(3,9,6),cplcFvFvAhL(3,3,6),cplcFvFvAhR(3,3,6),        & 
& cplcFvFvhhL(3,3,6),cplcFvFvhhR(3,3,6),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),               & 
& cplcFvFvVZpL(3,3),cplcFvFvVZpR(3,3),cplChiChiAhL(9,9,6),cplChiChiAhR(9,9,6),           & 
& cplChiChihhL(9,9,6),cplChiChihhR(9,9,6),cplChiChiVZL(9,9),cplChiChiVZR(9,9),           & 
& cplChiChiVZpL(9,9),cplChiChiVZpR(9,9),cplChiFvcSvL(9,3,6),cplChiFvcSvR(9,3,6)
...
Real(dp),Intent(in) :: MCha(2),MFd(3),MFu(3),MVWm,MHpm(2),MSu(6),MSd(6),MChi(9)

Complex(dp),Intent(in) :: cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplcFdChiSdL(3,9,6),cplcFdChiSdR(3,9,6),      & 
& cplcFdFuHpmL(3,3,2),cplcFdFuHpmR(3,3,2),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),           & 
& cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChiChacHpmL(9,2,2),cplChiChacHpmR(9,2,2),   & 
& cplChiChacVWmL(9,2),cplChiChacVWmR(9,2),cplChiFucSuL(9,3,6),cplChiFucSuR(9,3,6)
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MFv(3),MVWm,MHpm(2),MSv(6),MSe(6),MChi(9)

Complex(dp),Intent(in) :: cplcFeChaSvL(3,2,6),cplcFeChaSvR(3,2,6),cplcFeChiSeL(3,9,6),cplcFeChiSeR(3,9,6),      & 
& cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),           & 
& cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiChacHpmL(9,2,2),cplChiChacHpmR(9,2,2),   & 
& cplChiChacVWmL(9,2),cplChiChacVWmR(9,2),cplChiFvcSvL(9,3,6),cplChiFvcSvR(9,3,6)
...
Real(dp),Intent(in) :: MFd(3),MGlu,MSd(6),MChi(9)
...
Real(dp),Intent(in) :: MFu(3),MGlu,MSu(6),MChi(9)
...
End Module Chi3Decays_sec_UMSSM 
