...
! ------------------------------------------------------------------------------  
! File created at 1:13 on 7.11.2019   
! ----------------------------------------------------------------------  
 
 
Module LowEnergy_sec_UMSSM 
Use Control 
Use Settings 
...
Use StandardModel 
Use RunSM_sec_UMSSM
Use FlavorKit_LFV_sec_UMSSM
Use FlavorKit_QFV_sec_UMSSM
Use FlavorKit_Observables_sec_UMSSM
...
& MFv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MSv,MSv2,MVZp,MVZp2,cplcFeFeAhL,cplcFeFeAhR,         & 
...
& cplcFeFvHpmL,cplcFeFvHpmR,cplHpmcHpmVP,cplSecSeVP,a_mu)

Real(dp),Intent(in)  :: MAh(6),MAh2(6),MCha(2),MCha2(2),MChi(9),MChi2(9),MFe(3),MFe2(3),MFv(3),               & 
& MFv2(3),Mhh(6),Mhh2(6),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MSv(6),MSv2(6),MVZp,MVZp2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,6),cplcFeFeAhR(3,3,6),cplcFeChaSvL(3,2,6),cplcFeChaSvR(3,2,6),        & 
& cplcChaChaVPL(2,2),cplcChaChaVPR(2,2),cplChiFecSeL(9,3,6),cplChiFecSeR(9,3,6),         & 
& cplcFeChiSeL(3,9,6),cplcFeChiSeR(3,9,6),cplcFeFehhL(3,3,6),cplcFeFehhR(3,3,6),         & 
& cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),cplcChaFecSvL(2,3,6),& 
& cplcChaFecSvR(2,3,6),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),cplcFeFvHpmL(3,3,2),    & 
& cplcFeFvHpmR(3,3,2),cplHpmcHpmVP(2,2),cplSecSeVP(6,6)
...
& MFv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,             & 
...
& cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,cplHpmcHpmVP,cplSecSeVP,           & 
& cplcVWmVPVWm,EDM)

Implicit None
Real(dp),Intent(in)  :: MAh(6),MAh2(6),MCha(2),MCha2(2),MChi(9),MChi2(9),MFe(3),MFe2(3),MFv(3),               & 
& MFv2(3),Mhh(6),Mhh2(6),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MSv(6),MSv2(6),MVWm,            & 
...
& cplcFeFeVZpR(3,3),cplcChaFecSvL(2,3,6),cplcChaFecSvR(2,3,6),cplcFvFecHpmL(3,3,2),      & 
...
& MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhhhVZ,cplAhHpmcVWm,           & 
& cplcChaChaVZL,cplcChaChaVZR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,           & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFecVWmL,cplcFvFecVWmR,       & 
& cplcFvFvVZL,cplcFvFvVZR,cplcgAgWmcVWm,cplcgWmgWmVZ,cplcgWpCgAcVWm,cplcgWpCgWpCVZ,      & 
& cplcgWpCgZcVWm,cplcgWpCgZpcVWm,cplcgZgWmcVWm,cplcgZpgWmcVWm,cplChiChacVWmL,            & 
...
& cplhhhhVZVZ,cplhhHpmcVWm,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmcVWmVWm,cplHpmcHpmVZ,          & 
& cplHpmcHpmVZVZ,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdcVWmVWm,cplSdcSdVZ,     & 
...
Complex(dp),Intent(in)  :: cplAhAhcVWmVWm(6,6),cplAhAhVZVZ(6,6),cplAhhhVZ(6,6),cplAhHpmcVWm(6,2),cplcChaChaVZL(2,2),& 
...
& cplcgWpCgZpcVWm,cplcgZgWmcVWm,cplcgZpgWmcVWm,cplChiChacVWmL(9,2),cplChiChacVWmR(9,2),  & 
& cplChiChiVZL(9,9),cplChiChiVZR(9,9),cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,             & 
& cplcVWmcVWmVWmVWm3,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmVPVWm,       & 
& cplcVWmVWmVZ,cplcVWmVWmVZp,cplcVWmVWmVZpVZp1,cplcVWmVWmVZpVZp2,cplcVWmVWmVZpVZp3,      & 
& cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplhhcVWmVWm(6),cplhhhhcVWmVWm(6,6),   & 
& cplhhhhVZVZ(6,6),cplhhHpmcVWm(6,2),cplhhVZVZ(6),cplhhVZVZp(6),cplHpmcHpmcVWmVWm(2,2),  & 
& cplHpmcHpmVZ(2,2),cplHpmcHpmVZVZ(2,2),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),cplHpmcVWmVZp(2),& 
& cplSdcSdcVWmVWm(6,6),cplSdcSdVZ(6,6),cplSdcSdVZVZ(6,6),cplSdcSucVWm(6,6),              & 
& cplSecSecVWmVWm(6,6),cplSecSeVZ(6,6),cplSecSeVZVZ(6,6),cplSecSvcVWm(6,6),              & 
& cplSucSucVWmVWm(6,6),cplSucSuVZ(6,6),cplSucSuVZVZ(6,6),cplSvcSvcVWmVWm(6,6),           & 
& cplSvcSvVZ(6,6),cplSvcSvVZVZ(6,6)
...
& MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplcChaChaVPL,      & 
...
& cplcgWpCgWpCVZ,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,              & 
...
& cplcVWmVWmVZVZp1,cplcVWmVWmVZVZp2,cplcVWmVWmVZVZp3,Spar,Tpar,Upar)
...
& cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,cplcVWmcVWmVWmVWm1,& 
& cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplcVWmVWmVZpVZp1,cplcVWmVWmVZpVZp2,   & 
& cplcVWmVWmVZpVZp3,kont,PiWW_mw2)
...
Subroutine CalculateLowEnergyConstraints(g1input,g2input,g3input,gpinput,             & 
& Ydinput,Yeinput,laminput,Yvinput,kapinput,Yuinput,Tdinput,Teinput,Tlaminput,           & 
& Tvinput,Tkinput,Tuinput,mq2input,ml2input,mHd2input,mHu2input,md2input,mu2input,       & 
& me2input,ms2input,ms12input,ms22input,ms32input,mv2input,M1input,M2input,              & 
& M3input,M4input,vdinput,vuinput,vSinput,vS1input,vS2input,vS3input,Tpar,               & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,gpinput,mHd2input,mHu2input,ms2input,ms12input,               & 
& ms22input,ms32input,vdinput,vuinput,vSinput,vS1input,vS2input,vS3input

Complex(dp),Intent(inout) :: Ydinput(3,3),Yeinput(3,3),laminput,Yvinput(3,3),kapinput,Yuinput(3,3),Tdinput(3,3),   & 
...
Complex(dp) :: cplAhAhAh(6,6,6),cplAhAhcVWmVWm(6,6),cplAhAhhh(6,6,6),cplAhAhVZVZ(6,6),               & 
& cplAhAhVZVZp(6,6),cplAhcHpmVWm(6,2),cplAhhhhh(6,6,6),cplAhhhVZ(6,6),cplAhhhVZp(6,6),   & 
...
& cplcFvFvVZpR(3,3),cplcFvFvVZR(3,3),cplcgAgWmcVWm,cplcgWmgWmVP,cplcgWmgWmVZ,            & 
& cplcgWpCgAcVWm,cplcgWpCgWpCVP,cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgWpCgZpcVWm,           & 
& cplcgZgWmcVWm,cplcgZpgWmcVWm,cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChaFvcSeL(2,3,6),& 
...
& cplChiFvcSvR(9,3,6),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcHpmVWmVZp(2),cplcVWmcVWmVWmVWm1,& 
...
Complex(dp) :: cplcVWmVPVWmVZp2,cplcVWmVPVWmVZp3,cplcVWmVWmVZ,cplcVWmVWmVZp,cplcVWmVWmVZpVZp1,        & 
...
& cplGluFucSuL(3,6),cplGluFucSuR(3,6),cplGluGluVGL,cplGluGluVGR,cplhhcHpmVWm(6,2),       & 
& cplhhcVWmVWm(6),cplhhhhcVWmVWm(6,6),cplhhhhhh(6,6,6),cplhhhhVZVZ(6,6),cplhhhhVZVZp(6,6),& 
...
& cplHpmcHpmVPVZp(2,2),cplHpmcHpmVZ(2,2),cplHpmcHpmVZp(2,2),cplHpmcHpmVZVZ(2,2),         & 
& cplHpmcHpmVZVZp(2,2),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),cplHpmcVWmVZp(2),cplHpmSucSd(2,6,6),& 
& cplHpmSvcSe(2,6,6),cplSdcHpmcSu(6,2,6),cplSdcSdcVWmVWm(6,6),cplSdcSdVG(6,6),           & 
& cplSdcSdVP(6,6),cplSdcSdVPVP(6,6),cplSdcSdVPVZ(6,6),cplSdcSdVPVZp(6,6),cplSdcSdVZ(6,6),& 
& cplSdcSdVZp(6,6),cplSdcSdVZVZ(6,6),cplSdcSdVZVZp(6,6),cplSdcSucVWm(6,6),               & 
& cplSecHpmcSv(6,2,6),cplSecSecVWmVWm(6,6),cplSecSeVP(6,6),cplSecSeVPVP(6,6),            & 
& cplSecSeVPVZ(6,6),cplSecSeVPVZp(6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplSecSeVZVZ(6,6),& 
& cplSecSeVZVZp(6,6),cplSecSvcVWm(6,6),cplSucSdVWm(6,6),cplSucSucVWmVWm(6,6),            & 
& cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSuVPVP(6,6),cplSucSuVPVZ(6,6),cplSucSuVPVZp(6,6),& 
& cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplSucSuVZVZ(6,6),cplSucSuVZVZp(6,6),cplSvcSeVWm(6,6),& 
& cplSvcSvcVWmVWm(6,6),cplSvcSvVZ(6,6),cplSvcSvVZp(6,6),cplSvcSvVZVZ(6,6),               & 
& cplSvcSvVZVZp(6,6),cplVGVGVG
...
& PVO4lTRRcross(3,3,3,3),OA2lSL(3,3),OA2lSR(3,3),OA1L(3,3),OA1R(3,3),OH2lSL(3,3,6),      & 
...
& OAh2qSLSM(3,3,6),OAh2qSRSM(3,3,6),OA2qSLSM(3,3),OA2qSRSM(3,3),OA2qVLSM(3,3),           & 
& OA2qVRSM(3,3),OG2qSLSM(3,3),OG2qSRSM(3,3),OH2qSLSM(3,3,6),OH2qSRSM(3,3,6)
...
& BO4dTRL(3,3,3,3),BO4dTRR(3,3,3,3),OAh2qSL(3,3,6),OAh2qSR(3,3,6),OA2qSL(3,3),           & 
& OA2qSR(3,3),OA2qVL(3,3),OA2qVR(3,3),OG2qSL(3,3),OG2qSR(3,3),OH2qSL(3,3,6),             & 
& OH2qSR(3,3,6)
...
& OAh2qSLcheck(3,3,6),OAh2qSRcheck(3,3,6),OA2qSLcheck(3,3),OA2qSRcheck(3,3),             & 
& OA2qVLcheck(3,3),OA2qVRcheck(3,3),OG2qSLcheck(3,3),OG2qSRcheck(3,3),OH2qSLcheck(3,3,6),& 
& OH2qSRcheck(3,3,6)
...
scale_save = Qin 
Call RunSM_and_SUSY_RGEs(160._dp,g1input,g2input,g3input,gpinput,Ydinput,             & 
...
& me2,ms2,ms12,ms22,ms32,mv2,M1,M2,M3,M4,vd,vu,vS,vS1,vS2,vS3,CKM_160,sinW2_160,         & 
...
MHpm(1)=MVWm
MHpm2(1)=MVWm2
Call AllCouplings(lam,Tlam,kap,Tk,ZA,g1,g2,gp,vd,vu,vS,vS1,vS2,vS3,ZH,ZP,             & 
& Yd,Td,ZD,Ye,Te,ZE,Yu,Tu,ZU,Yv,Tv,ZV,TW,TWp,g3,UM,UP,ZN,ZDL,ZDR,ZEL,ZER,ZUL,            & 
& ZUR,ZVL,ZVR,pG,cplAhAhAh,cplAhAhhh,cplAhhhhh,cplAhHpmcHpm,cplAhSdcSd,cplAhSecSe,       & 
& cplAhSucSu,cplAhSvcSv,cplhhhhhh,cplhhHpmcHpm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,         & 
& cplhhSvcSv,cplHpmSucSd,cplHpmSvcSe,cplSdcHpmcSu,cplSecHpmcSv,cplAhhhVZ,cplAhhhVZp,     & 
& cplAhHpmcVWm,cplAhcHpmVWm,cplhhHpmcVWm,cplhhcHpmVWm,cplHpmcHpmVP,cplHpmcHpmVZ,         & 
& cplHpmcHpmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSdcSucVWm,               & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSecSvcVWm,cplSucSuVG,cplSucSuVP,cplSucSdVWm,      & 
& cplSucSuVZ,cplSucSuVZp,cplSvcSeVWm,cplSvcSvVZ,cplSvcSvVZp,cplhhcVWmVWm,cplhhVZVZ,      & 
& cplhhVZVZp,cplhhVZpVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplcHpmVPVWm,           & 
& cplcHpmVWmVZ,cplcHpmVWmVZp,cplVGVGVG,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,          & 
...
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFvFvhhL,cplcFvFvhhR,             & 
& cplcFeFvHpmL,cplcFeFvHpmR,cplcFdGluSdL,cplcFdGluSdR,cplcFuGluSuL,cplcFuGluSuR,         & 
& cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,cplChiChacVWmL,cplChiChacVWmR, & 
& cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR, & 
& cplChiChiVZL,cplChiChiVZR,cplChiChiVZpL,cplChiChiVZpR,cplcChaChiVWmL,cplcChaChiVWmR,   & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFeFeVPL,cplcFeFeVPR,         & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFvFecVWmL,cplcFvFecVWmR,         & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZpL,cplcFuFuVZpR,cplcFeFvVWmL,cplcFeFvVWmR,           & 
& cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,cplGluGluVGL,cplGluGluVGR)
...
& MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,          & 
& cplAhAhhh,cplAhcHpmVWm,cplAhhhhh,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,       & 
& cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhSvcSv,cplcChaChaAhL,cplcChaChaAhR,               & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZpL,  & 
& cplcChaChaVZpR,cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,cplcChaFecSvR,  & 
...
& cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFvFecHpmL,cplcFvFecHpmR,         & 
& cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvAhL,cplcFvFvAhR,cplcFvFvhhL,cplcFvFvhhR,           & 
& cplcFvFvVZL,cplcFvFvVZpL,cplcFvFvVZpR,cplcFvFvVZR,cplChiChiAhL,cplChiChiAhR,           & 
& cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZpL,cplChiChiVZpR,cplChiChiVZR,       & 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TSOddllSLL(gt1,gt2,gt3,gt4),TSOddllSRR(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TVOddllSLL(gt1,gt2,gt3,gt4),TVOddllSRR(gt1,gt2,gt3,gt4)& 
...
& MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,          & 
& cplAhAhhh,cplAhcHpmVWm,cplAhhhhh,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,       & 
& cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhSvcSv,cplcChacFvSeL,cplcChacFvSeR,               & 
& cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZpL,  & 
& cplcChaChaVZpR,cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,    & 
...
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFdGluSdL,cplcFdGluSdR,cplcFeFeAhL,cplcFeFeAhR,           & 
...
& cplChaFvcSeL,cplChaFvcSeR,cplChiChiAhL,cplChiChiAhR,cplChiChihhL,cplChiChihhR,         & 
& cplChiChiVZL,cplChiChiVZpL,cplChiChiVZpR,cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,       & 
& cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,cplcHpmVWmVZp,cplcVWmVWmVZ,cplcVWmVWmVZp,       & 
...
& cplhhVZVZp,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVZ,           & 
& cplSdcSdVZp,cplSecSeVZ,cplSecSeVZp,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,      & 
...
& MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmVWm,cplAhhhhh,             & 
& cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplcChaChaAhL,    & 
& cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,   & 
& cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,               & 
& cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdAhL,cplcFdFdAhR,           & 
...
& cplcFuFuVZpR,cplcFuFuVZR,cplChiChiAhL,cplChiChiAhR,cplChiChihhL,cplChiChihhR,          & 
& cplChiChiVZL,cplChiChiVZpL,cplChiChiVZpR,cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,       & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSucSu,cplhhVZpVZp,cplhhVZVZ,       & 
...
& cplSucSuVZ,cplSucSuVZp,TSO4dSLL(gt1,gt2,gt3,gt4),TSO4dSRR(gt1,gt2,gt3,gt4)             & 
...
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,cplSucSuVP,      & 
& cplSucSuVZ,cplSucSuVZp,TVO4dSLL(gt1,gt2,gt3,gt4),TVO4dSRR(gt1,gt2,gt3,gt4)             & 
...
& MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,              & 
& MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhcHpmVWm,       & 
& cplAhHpmcHpm,cplAhHpmcVWm,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,     & 
...
& cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplChiFdcSdL,cplChiFdcSdR,cplChiFecSeL,   & 
& cplChiFecSeR,cplChiFucSuL,cplChiFucSuR,cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,         & 
& cplcHpmVWmVZp,cplcVWmVWmVZ,cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,       & 
& cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVZ,         & 
& cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSvcSe,cplSdcHpmcSu,cplSdcSucVWm,        & 
& cplSvcSeVWm,TSOdulvSLL(gt1,gt2,gt3,gt4),TSOdulvSRR(gt1,gt2,gt3,gt4),TSOdulvSRL(gt1,gt2,gt3,gt4)& 
...
& cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVZ,         & 
& cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSvcSe,cplSdcHpmcSu,cplSdcSucVWm,        & 
& cplSvcSeVWm,TVOdulvSLL(gt1,gt2,gt3,gt4),TVOdulvSRR(gt1,gt2,gt3,gt4),TVOdulvSRL(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,BOddllSLL(gt1,gt2,gt3,gt4),BOddllSRR(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PSOddllSLL(gt1,gt2,gt3,gt4),PSOddllSRR(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PVOddllSLL(gt1,gt2,gt3,gt4),PVOddllSRR(gt1,gt2,gt3,gt4)& 
...
& MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmVWm,cplAhhhhh,cplAhhhVZ,        & 
& cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplcChaChaAhL,              & 
& cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,   & 
& cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,               & 
& cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdAhL,cplcFdFdAhR,           & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,               & 
...
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,cplSucSuVP,      & 
& cplSucSuVZ,cplSucSuVZp,BO4dSLL(gt1,gt2,gt3,gt4),BO4dSRR(gt1,gt2,gt3,gt4)               & 
...
& MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmVWm,cplAhhhhh,cplAhhhVZ,              & 
& cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplcChaChaAhL,              & 
& cplcChaChaAhR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,      & 
& cplcFdChiSdR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,              & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,          & 
...
& MFd,MFd2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSu,MSu2,MVWm,               & 
& MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplcChaChaVPL,cplcChaChaVPR,cplcChaFdcSuL,cplcChaFdcSuR,     & 
& cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdAhL,cplcFdFdAhR,           & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,              & 
& cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,          & 
...
& MFd,MFd2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSu,MSu2,MVWm,               & 
& MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,       & 
& cplcFdChiSdL,cplcFdChiSdR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,             & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,             & 
...
& cplSdcSdVG,cplSucSuVG,OG2qSL(gt1,gt2),OG2qSR(gt1,gt2))
...
& MFd2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSu,MSu2,MVWm,MVWm2,             & 
& MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplAhhhVZp,cplcChaChahhL,            & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSucSu,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,      & 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TSOddllSLLSM(gt1,gt2,gt3,gt4),TSOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TVOddllSLLSM(gt1,gt2,gt3,gt4),TVOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,cplSucSuVP,      & 
& cplSucSuVZ,cplSucSuVZp,TSO4dSLLSM(gt1,gt2,gt3,gt4),TSO4dSRRSM(gt1,gt2,gt3,gt4)         & 
...
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,cplSucSuVP,      & 
& cplSucSuVZ,cplSucSuVZp,TVO4dSLLSM(gt1,gt2,gt3,gt4),TVO4dSRRSM(gt1,gt2,gt3,gt4)         & 
...
& cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVZ,         & 
& cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSvcSe,cplSdcHpmcSu,cplSdcSucVWm,        & 
& cplSvcSeVWm,TSOdulvSLLSM(gt1,gt2,gt3,gt4),TSOdulvSRRSM(gt1,gt2,gt3,gt4),               & 
...
& cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVZ,         & 
& cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSvcSe,cplSdcHpmcSu,cplSdcSucVWm,        & 
& cplSvcSeVWm,TVOdulvSLLSM(gt1,gt2,gt3,gt4),TVOdulvSRRSM(gt1,gt2,gt3,gt4),               & 
...
& MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,cplAhAhhh,         & 
& cplAhcHpmVWm,cplAhhhhh,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,      & 
& cplAhSecSe,cplAhSucSu,cplAhSvcSv,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,            & 
...
& cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,             & 
...
& cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,       & 
& cplcFvFecVWmR,cplcFvFvAhL,cplcFvFvAhR,cplcFvFvhhL,cplcFvFvhhR,cplcFvFvVZL,             & 
& cplcFvFvVZpL,cplcFvFvVZpR,cplcFvFvVZR,cplChiChiAhL,cplChiChiAhR,cplChiChihhL,          & 
...
& cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplhhcHpmVWm,        & 
...
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,        & 
& cplSvcSvVZp,BOddllSLLSM(gt1,gt2,gt3,gt4),BOddllSRRSM(gt1,gt2,gt3,gt4),BOddllSRLSM(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PSOddllSLLSM(gt1,gt2,gt3,gt4),PSOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PVOddllSLLSM(gt1,gt2,gt3,gt4),PVOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,cplSucSuVP,      & 
& cplSucSuVZ,cplSucSuVZp,BO4dSLLSM(gt1,gt2,gt3,gt4),BO4dSRRSM(gt1,gt2,gt3,gt4)           & 
...
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVGL,cplcFuFuVGR,       & 
& cplChiFdcSdL,cplChiFdcSdR,cplGluFdcSdL,cplGluFdcSdR,cplGluGluVGL,cplGluGluVGR,         & 
& cplSdcSdVG,cplSucSuVG,OG2qSLSM(gt1,gt2),OG2qSRSM(gt1,gt2))
...
If (MatchingOrder.gt.-1) Then 
Call RunSM_and_SUSY_RGEs(mz,g1input,g2input,g3input,gpinput,Ydinput,Yeinput,          & 
...
& M4input,vdinput,vuinput,vSinput,vS1input,vS2input,vS3input,g1,g2,g3,gp,Yd,             & 
& Ye,lam,Yv,kap,Yu,Td,Te,Tlam,Tv,Tk,Tu,mq2,ml2,mHd2,mHu2,md2,mu2,me2,ms2,ms12,           & 
& ms22,ms32,mv2,M1,M2,M3,M4,vd,vu,vS,vS1,vS2,vS3,CKM_MZ,sinW2_MZ,Alpha_MZ,               & 
& AlphaS_MZ,.true.)
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TSOllddSLL(gt1,gt2,gt3,gt4),TSOllddSRR(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TVOllddSLL(gt1,gt2,gt3,gt4),TVOllddSRR(gt1,gt2,gt3,gt4)& 
...
& cplcChaChaVZL,cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChaVZR,cplcChaFecSvL,               & 
...
& cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeChaSvL,cplcFeChaSvR,cplcFeChiSeL,         & 
...
& cplcFuFuVZR,cplcFuGluSuL,cplcFuGluSuR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,       & 
& cplcFvFecVWmR,cplcFvFvAhL,cplcFvFvAhR,cplcFvFvhhL,cplcFvFvhhR,cplcFvFvVZL,             & 
& cplcFvFvVZpL,cplcFvFvVZpR,cplcFvFvVZR,cplChaFucSdL,cplChaFucSdR,cplChiChiAhL,          & 
...
& cplcHpmVWmVZ,cplcHpmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplGluFucSuL,       & 
& cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,            & 
& cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,          & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,        & 
& cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TSOlluuSLL(gt1,gt2,gt3,gt4)              & 
...
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,        & 
& cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TVOlluuSLL(gt1,gt2,gt3,gt4)              & 
...
& MChi2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MSv,MSv2,MVWm,MVWm2,              & 
& MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmVWm,cplAhhhhh,cplAhhhVZ,              & 
& cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSecSe,cplAhSvcSv,cplcChaChaAhL,              & 
& cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,   & 
& cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChaVZR,cplcChaFecSvL,cplcChaFecSvR,               & 
...
& cplChiChiVZpR,cplChiChiVZR,cplChiFecSeL,cplChiFecSeR,cplcHpmVPVWm,cplcHpmVWmVZ,        & 
& cplcHpmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplhhcHpmVWm,cplhhcVWmVWm,       & 
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,TSO4lSLL(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,TVO4lSLL(gt1,gt2,gt3,gt4)& 
...
& MChi,MChi2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MSv,MSv2,MVWm,               & 
& MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmVWm,cplAhhhhh,cplAhhhVZ,        & 
& cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSecSe,cplAhSvcSv,cplcChaChaAhL,              & 
& cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,   & 
& cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChaVZR,cplcChaFecSvL,cplcChaFecSvR,               & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,TSO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,TVO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,BOllddSLL(gt1,gt2,gt3,gt4),BOllddSRR(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PSOllddSLL(gt1,gt2,gt3,gt4),PSOllddSRR(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,         & 
& cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,        & 
& cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PVOllddSLL(gt1,gt2,gt3,gt4),PVOllddSRR(gt1,gt2,gt3,gt4)& 
...
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,        & 
& cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,BOlluuSLL(gt1,gt2,gt3,gt4)               & 
...
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,        & 
& cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PSOlluuSLL(gt1,gt2,gt3,gt4)              & 
...
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,        & 
& cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PVOlluuSLL(gt1,gt2,gt3,gt4)              & 
...
& MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,           & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmVWm,cplAhhhhh,cplAhhhVZ,cplAhhhVZp,            & 
& cplAhHpmcHpm,cplAhHpmcVWm,cplAhSecSe,cplAhSvcSv,cplcChaChaAhL,cplcChaChaAhR,           & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZpL,  & 
& cplcChaChaVZpR,cplcChaChaVZR,cplcChaFecSvL,cplcChaFecSvR,cplcFeChaSvL,cplcFeChaSvR,    & 
...
& cplcVWmVWmVZ,cplcVWmVWmVZp,cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHpmcHpm,           & 
& cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,      & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSecSeVP,         & 
& cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,BO4lSLL(gt1,gt2,gt3,gt4),BO4lSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,PSO4lSLL(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,PVO4lSLL(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,BO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,PSO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,          & 
& cplHpmcVWmVZp,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,PVO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,           & 
& MVZp,MVZp2,cplcChaChaVPL,cplcChaChaVPR,cplcChaFecSvL,cplcChaFecSvR,cplcFeChaSvL,       & 
...
& cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplChiFecSeL,cplChiFecSeR,cplcHpmVPVWm,      & 
& cplcVWmVPVWm,cplHpmcHpmVP,cplHpmcVWmVP,cplSecSeVP,OA2lSL(gt1,gt2),OA2lSR(gt1,gt2)      & 
...
& MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,               & 
& MVZp,MVZp2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplAhhhVZp,cplcChaChahhL,cplcChaChahhR,       & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,OH2lSL(gt1,gt2,gt3),OH2lSR(gt1,gt2,gt3))
...
& MFe2,MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,               & 
& MVZp,MVZp2,cplAhhhVZ,cplcChaChaVZL,cplcChaChaVZR,cplcChaFecSvL,cplcChaFecSvR,          & 
& cplcFeChaSvL,cplcFeChaSvR,cplcFeChiSeL,cplcFeChiSeR,cplcFeFeAhL,cplcFeFeAhR,           & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,             & 
& cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHpmL,cplcFvFecHpmR,       & 
& cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplChiChiVZL,cplChiChiVZR,         & 
& cplChiFecSeL,cplChiFecSeR,cplcHpmVWmVZ,cplcVWmVWmVZ,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSecSeVZ,cplSvcSvVZ,OZ2lSL(gt1,gt2),OZ2lSR(gt1,gt2)        & 
...
& MHpm,MHpm2,MSe,MSe2,MSv,MSv2,MVZp,MVZp2,cplcFeFeAhL,cplcFeFeAhR,cplcFeChaSvL,          & 
& cplcFeChaSvR,cplcChaChaVPL,cplcChaChaVPR,cplChiFecSeL,cplChiFecSeR,cplcFeChiSeL,       & 
& cplcFeChiSeR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZpL,             & 
& cplcFeFeVZpR,cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFeFvHpmL,     & 
& cplcFeFvHpmR,cplHpmcHpmVP,cplSecSeVP,ae)
...
& cplcFeChiSeR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZpL,             & 
& cplcFeFeVZpR,cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFeFvHpmL,     & 
& cplcFeFvHpmR,cplHpmcHpmVP,cplSecSeVP,amu)
...
& cplcFeChiSeR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZpL,             & 
& cplcFeFeVZpR,cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFeFvHpmL,     & 
& cplcFeFvHpmR,cplHpmcHpmVP,cplSecSeVP,atau)


! *****  Lepton EDM ***** 

Call LeptonEDM(1,MAh,MAh2,MCha,MCha2,MChi,MChi2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,           & 
& MHpm,MHpm2,MSe,MSe2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplcFeFeAhL,               & 
...
& cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,cplHpmcHpmVP,cplSecSeVP,cplcVWmVPVWm,EDMe)
...
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZpL,cplcFeFeVZpR,cplcChaFecSvL,           & 
& cplcChaFecSvR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHpmL,    & 
& cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,cplHpmcHpmVP,cplSecSeVP,cplcVWmVPVWm,EDMmu)
...
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZpL,cplcFeFeVZpR,cplcChaFecSvL,           & 
& cplcChaFecSvR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHpmL,    & 
& cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,cplHpmcHpmVP,cplSecSeVP,cplcVWmVPVWm,EDMtau)
...
sinW2=0.22290_dp 
TW = asin(sqrt(sinW2)) 
mW2=(1._dp-sinW2)*mz2 + (g2**2*(vd**2 + vu**2 - (vd**2 + vu**2)*Cos(TWp)**2 - (4*gp*Sin(TWp)*(Sqrt(g1**2 + g2**2)*(QHd*vd**2 - QHu*vu**2)*Cos(TWp) + gp*(QHd**2*vd**2 + Qs**2*vS**2 + Qs1**2*vS1**2 + Qs2**2*vS2**2 + Qs3**2*vS3**2 + QHu**2*vu**2)*Sin(TWp)))/(g1**2 + g2**2)))/4._dp
...
& MFv,MFv2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,           & 
& MVZ,MVZ2,MVZp,MVZp2,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhhhVZ,cplAhHpmcVWm,cplcChaChaVZL,   & 
...
& cplcgWpCgZpcVWm,cplcgZgWmcVWm,cplcgZpgWmcVWm,cplChiChacVWmL,cplChiChacVWmR,            & 
...
& cplhhHpmcVWm,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmcVWmVWm,cplHpmcHpmVZ,cplHpmcHpmVZVZ,       & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdcVWmVWm,cplSdcSdVZ,cplSdcSdVZVZ,       & 
& cplSdcSucVWm,cplSecSecVWmVWm,cplSecSeVZ,cplSecSeVZVZ,cplSecSvcVWm,cplSucSucVWmVWm,     & 
& cplSucSuVZ,cplSucSuVZVZ,cplSvcSvcVWmVWm,cplSvcSvVZ,cplSvcSvVZVZ,dRho)
...
& MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplcChaChaVPL,               & 
& cplcChaChaVPR,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuVPL,             & 
& cplcFuFuVPR,cplcgWmgWmVP,cplcgWpCgWpCVP,cplHpmcHpmVP,cplHpmcVWmVP,cplSdcSdVP,          & 
& cplSecSeVP,cplSucSuVP,cplcVWmVPVWm,cplHpmcHpmVPVP,cplSdcSdVPVP,cplSecSeVPVP,           & 
& cplSucSuVPVP,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplAhhhVZ,cplcChaChaVZL,  & 
...
End Module LowEnergy_sec_UMSSM 
