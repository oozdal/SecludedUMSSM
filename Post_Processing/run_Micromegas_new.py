...
for j in range(1,numberofoutput):
	...
	MicromegasNewFileName       = "Micromegas."+str(j)
	...
	if outputfilefullpath_Exist == True and (FullDestForMicromegas_Exist and FullDestForChannels_Exist) == False:
		LHA = MyPySLHA()
		...
		if (LHA.FullDestForMicromegas_Exist and LHA.FullDestForChannels_Exist) == False: LHA.MicroDestFile_Check = True
