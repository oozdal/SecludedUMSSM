...
Model`Name = "sUMSSM";
Model`NameLaTeX ="secluded UMSSM";
Model`Authors = "O.Ozdal";
Model`Date = "2021-02-04";
...
SuperFields[[12]] = {vR, 3, conj[vR],      0, 1,  1, Qv, RpM};
...
SuperPotential = Yu u.q.Hu - Yd d.q.Hd - Ye e.l.Hd + Yv l.Hu.vR + \[Lambda] Hu.Hd.s + \[Kappa]/3 s1.s2.s3;
